                        ...
                        <div class="col-lg-6">
                            <div class="single-recent-blog-post card-view">
                                ...
                                <div class="details mt-20">
                                    ...
                                    <p><?php if (strlen($p->info) > 300) {
                                            echo substr($p->info, 0, 300) . '...';
                                        } ?></p>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="blog-pagination justify-content-center d-flex">
                            ...
                            <?php if ($pagelist > 1) : ?>
                                            <li class="page-item">
                                                <a href="index.php?page=posts&&pagelist=<?= $pagelist - 1 ?>" class="page-link" aria-label="Previous">
                                        ...
                                        for ($i = 1; $i <= $pagesCount; $i++) :
                                            ...
                                            ?>
                                                <li class="page-item">
                                                    <a href="index.php?page=posts&&pagelist=<?= $i ?>" class="page-link active-page">
                                                        <?= $i ?>
                                                    </a>
                                                </li>
                                            <?php else : ?>
                                                <li class="page-item">
                                                    <a href="index.php?page=posts&&pagelist=<?= $i ?>" class="page-link">
                                                        <?= $i ?>
                                                    </a>
                                                </li>
                                            <?php
                                        ...
                                        if ($pagelist < $pagesCount) :
                                            ?>
                                            <li class="page-item">
                                                <a href="index.php?page=posts&&pagelist=<?= $pagelist + 1 ?>" class="page-link" aria-label="Next">
                                                    <span aria-hidden="true">
