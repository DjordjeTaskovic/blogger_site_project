...
<div class="widget-wrap">
  ...
  <a href="index.php?page=blog_form"
   class="bbtns d-block mt-2 w-100 text-center">Add New Blog</a>
  </div>
</div>
</div>
<div class="col-lg-6">
...
$blogsbyuser = getBlogsbyUserID($userID);
  if(!$blogsbyuser){
    ...
    <h3>You need to post more blogs...</h3>
    </div>';
  }
...
?>
    <div class="single-recent-blog-post">
        ...
        <p><?php if(strlen($b->info)>300){echo substr($b->info,0,300).'...';}else{echo $b->info;}?>
        </p>
